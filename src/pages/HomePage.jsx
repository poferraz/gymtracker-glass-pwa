...
import { SessionStartButton, ActiveSessionBanner } from '../components/features';
    ...
    <div className="space-y-6">
      ...
      <GlassCard>
        ...
        <GlassButton variant="primary">
          <PlayOutline width={24} height={24} className="mr-2" /> Start New Workout
        </GlassButton>
      </GlassCard>
      ...
      <GlassCard>
        ...
        <GlassButton onClick={handleCreateSession}>
          <PlayOutline width={24} height={24} className="mr-2" /> Create Test Session
        </GlassButton>
      </GlassCard>
